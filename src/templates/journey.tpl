    ...
    <body>
        <main>
                ...
                <tbody>
                    ...
                    <tr class="leg">
                        ...
                        <td class="actions"><span class="material-symbols-outlined">menu</span><menu>
                            <li><a class="button action add-before" 
                            ...
                            <li><a class="button action add-after" 
                            ...
                            <li><a class="button action delete" 
                                    href="delete_leg.php?j={$journey_string}&pos={$leg@index}"
                                    title="Delete leg">
                                <span class="material-symbols-outlined">delete</span>
                                <span>Delete</span>
                            </a></li>
                            <li><a class="button action view" href="{$leg->url}" title="View on Realtime Trains">
            ...
            <div class="end-actions"><menu>
                <li><a class="button action add-at-end" 
