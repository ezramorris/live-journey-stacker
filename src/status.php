...
function get_train_leg_status(string $serviceId, DateTimeImmutable $date,
    ...
    return TrainLegStatus::parse($date, $data, $boarding_crs, $alighting_crs);
}